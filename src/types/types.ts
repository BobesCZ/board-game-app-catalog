...
export type MyBggStatusCollection =
  | MyBggCollection.WANTTOBUY
  | MyBggCollection.WANTTOPLAY
  | MyBggCollection.WISHLIST;
...
export type Game = Partial<
  Pick<BggThing, "id" | "primaryName" | "yearpublished" | "image">
> &
  Partial<
